    ...
    def test_full_pipeline_with_real_paper_structure(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                with open(
                    "data/selected/paper-201601.00051V1.json", "w", encoding="utf-8"
                ) as f:
                ...
                os.makedirs("data/translated", exist_ok=True)
                with open(
                    "data/translated/paper-201601.00051V1.json", "w", encoding="utf-8"
                ) as f:
                ...
                assert os.path.exists(
                    "site/items/paper-201601.00051V1/paper-201601.00051V1.md"
                )
