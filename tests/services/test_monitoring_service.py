...
class TestMonitoringService:
    ...
    def test_track_page_view(self):
        ...
        self.service.track_page_view(
            "/test-page", user_agent="Mozilla/5.0", ip_address="192.168.1.1"
        )
    ...
    def test_track_search(self):
        ...
        self.service.track_search(
            "machine learning", 25, user_agent="Mozilla/5.0", ip_address="192.168.1.1"
        )
    ...
    def test_get_analytics(self):
        ...
        self.service.track_page_view(
            "/page1", user_agent="Mozilla/5.0", ip_address="192.168.1.1"
        )
        self.service.track_page_view(
            "/page2", user_agent="Mozilla/5.0", ip_address="192.168.1.1"
        )
        self.service.track_search(
            "query1", 10, user_agent="Mozilla/5.0", ip_address="192.168.1.1"
        )
    ...
    def test_record_metric(self):
        ...
        self.service.record_metric(
            "test_metric", 100.5, unit="ms", metadata={"key": "value"}
        )
    ...
    def test_get_performance(self):
        ...
        response_times = [
            m for m in performance["metrics"] if m["name"] == "response_time"
        ]
    ...
    def test_get_status(self):
        ...
        self.service.track_page_view(
            "/test", user_agent="Mozilla/5.0", ip_address="192.168.1.1"
        )
    ...
    def test_cleanup_old_data(self):
        ...
        self.service.create_alert("info", "Recent Alert", "Recent message")
        self.service.track_page_view(
            "/recent", user_agent="Mozilla/5.0", ip_address="192.168.1.1"
        )
