...
class TestE2ESimple:
    ...
    def test_license_service(self):
        ...
        record = {"id": "test-1", "license": {"type": "CC BY", "raw": "CC BY"}}
        ...
        assert (
            "CC BY" in summary or "Unknown" in summary
        )  # License type might be preserved as label
    ...
    def test_error_handling(self):
        ...
        with patch(
            "src.services.translation_service.TranslationService._call_openrouter"
        ) as mock_translate:
    ...
    @patch(
        "src.services.translation_service.TranslationService._call_openrouter_synthesis"
    )
    @patch("src.services.translation_service.TranslationService._call_openrouter")
